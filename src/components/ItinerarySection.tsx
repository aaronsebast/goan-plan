...
const days = [
  {
    ...
    schedule: [
      ...
      { time: "11:30", activity: "Travel from Madgaon → Arpora", icon: "travel" },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:00", activity: "1️⃣ Colva Beach - morning calm", icon: "beach" },
      { time: "09:00", activity: "2️⃣ Betalbatim Beach - quick stop", icon: "beach" },
      { time: "10:30", activity: "3️⃣ Cabo de Rama Beach & Fort - views & photos 🏛️", icon: "fort" },
      { time: "12:30", activity: "Non-veg Thali lunch - Fish/Chicken thali 🍛", icon: "food" },
      { time: "14:00", activity: "4️⃣ Cola Beach - lagoon & kayaking 🚣", icon: "beach" },
      { time: "15:30", activity: "5️⃣ Agonda Beach - short peaceful stop", icon: "beach" },
      { time: "16:30", activity: "6️⃣ Butterfly Beach - viewpoint + walk 🦋", icon: "beach" },
      { time: "18:00", activity: "7️⃣ Palolem Beach - SUNSET 🌅", icon: "sunset" },
      { time: "19:30", activity: "Night ride back to Arpora ⚠️ (ride slow & safe)", icon: "travel" },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "16:00", activity: "Harvalem (Arvalem) Area - if time permits 🏞️", icon: "nature" },
