...
import { Wallet, Utensils, Bike, Fuel, Beer, Camera, Ticket, IndianRupee } from "lucide-react";
...
const dailyBudgets: DayBudget[] = [
  ...
  },
  {
    ...
    total: "₹1,500 - ₹2,200",
    items: [
      { category: "Food", icon: Utensils, estimate: "₹400-550", notes: "Breakfast + Non-veg thali lunch + Dinner" },
      { category: "Scooter Rent", icon: Bike, estimate: "₹350-450", notes: "Already rented (Day 1 rate applies)" },
      { category: "Petrol", icon: Fuel, estimate: "₹300-400", notes: "~100-120 km South Goa coverage" },
      { category: "Activities", icon: Ticket, estimate: "₹200-400", notes: "Kayaking at Cola Beach, tips" },
      { category: "Miscellaneous", icon: Camera, estimate: "₹150-300", notes: "Tea, snacks, water" },
    ],
  },
  {
    day: "Day 3",
    ...
    items: [
      ...
      { category: "Sightseeing", icon: Ticket, estimate: "₹50-100", notes: "Church visit, tips" },
              ...
              <Card className={`h-full ${dayBudget.day === "Day 2 Alt" ? "border-accent/50 bg-accent/5" : ""}`}>
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div>
                            <span className="inline-block rounded-full px-3 py-1 text-xs font-semibold bg-secondary/20 text-secondary">
                        {dayBudget.day}
                      </span>
